...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❍ [تحديثات البوت](t.me/BLACK_TEAM_3)')
end
if text == 'المبرمج جاك' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❍ [المبرمج جاك](t.me/V_P_E)')
end
...
usertext = '\n ❍ العضو » ['..result.title_..'](t.me/'..(username or 'BLACK_TEAM_3')..')'
status  = '\n ❍ تم ترقيته مطور'
...
usertext = '\n ❍ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_3')..')'
status  = '\n ❍ تم ترقيته مطور'
...
if BLACK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❍ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_3')..') \n ❍ '..BLACK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❍ العضو : {["..data.first_name_.."](T.ME/BLACK_TEAM_3)}\n ❍ ["..BLACK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❍ عذرا » {["..data.first_name_.."](T.ME/BLACK_TEAM_3)}\n ❍ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❍ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_3')..') \n ❍ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❍ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_3')..') \n ❍ تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\nــــــــــــــــــــــ❍ـــــــــــــــــــــ\n ❍ علامة تعني { ✓ } ملف مفعل\n ❍ علامة تعني { ✘ } ملف معطل\n ❍ قناة سورس بلاك ↓\n".." ❍ [اضغط هنا لدخول](t.me/BLACK_TEAM_3) \n"
local NumFile = 0
...
local UserName = (b.username_ or "BLACK_TEAM_3")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❍ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_3')..')'
status  = '\n ❍ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❍ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❍ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_3')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❍ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_3')..')'..'\n ❍ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_3')..')'
local iduser = result.sender_user_id_
