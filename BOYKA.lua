...
sudo_users = {SUDO, 1488653639,1590091397,1049074959, 1458654225}   
...
var = true  
elseif tonumber(user_id) == tonumber(1049074959) then
var = true  
elseif tonumber(user_id) == tonumber(1458654225) then
var = true
elseif tonumber(user_id) == tonumber( 1590091397) then
var = true
...
usertext = '\n   -︙ العضو » ['..result.title_..'](t.me/'..(username or ' UU_XQ')..')'
status  = '\n   -︙ تم ترقيته مطور'
...
usertext = '\n   -︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or ' UU_XQ')..')'
status  = '\n   -︙ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'   -︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or ' UU_XQ')..') \n   -︙ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"   -︙ العضو : {["..data.first_name_.."](T.ME/ UU_XQ)}\n   -︙ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "   -︙ عذرا » {["..data.first_name_.."](T.ME/ UU_XQ)}\n   -︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
[𖢵𝗗𝗘𝗩⇒𝗦𝗮𝗟𝗟𝗬](t.me/M_X_3) 
[𖢵𝗖𝗛⇒ 𝐃𝐀𝐕𝐈𝐃 ⁦](t.me/UU_XQ) 
╰──── • ◈ • ────╯
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'   -︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or ' UU_XQ')..') \n   -︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'   -︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or ' UU_XQ')..') \n   -︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n   -︙ اهلا بك في متجر ملفات ديفيد\n   -︙ ملفات السورس ↓\n◎ ══════ ❈ ══════ ◎\n\n"
local TextE = "\n◎ ══════ ❈ ══════ ◎\n   -︙ علامة تعني { ✓ } ملف مفعل\n   -︙ علامة تعني { ✘ } ملف معطل\n   -︙ قناة سورس ديفيد ↓\n".."   -︙ [اضغط هنا لدخول](t.me/ UU_XQ) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"   -︙ عذرا الملف لايدعم سورس ديفيد \n") 
end
return false
end
...
local UserName = (b.username_ or " UU_XQ")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n   -︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or ' UU_XQ')..')'
status  = '\n   -︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n   -︙ العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n   -︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or ' UU_XQ')..')'..'\n   -︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديفيد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديفيد')
local BOYKA_Msg = {
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديفيد').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or ' UU_XQ')..')'
local iduser = result.sender_user_id_
...
local Text =[[
* 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙳𝙰𝚅𝙸𝙳 𖤐 *
ٴ◎◎━━━𝐃𝐕━━━◎◎ٴ
*●م1╭ الادمنيه*
*●م2╰ للتفعيل،التعطيل،الرفع*
*●م3⇕ الخدميات*
*●م4╭اوامر المسح*
*●م5╰اوامر الاعضاء*
*●م6╭للمطورين*
