...
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIREND IN FIRELES BOT"
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
exit 1
fi
if [ ! $token ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIREND IN FIRELE INFO.LUA \e[0m"
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./FIRE.lua -p PROFIRELE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FIRETEAM/Files_Boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1264922434,1019610884,1596391910}   
...
if hash or SudoBot(msg) or DevFIREW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevFIREW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1019610884) then
var = true 
...
FIRE_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
FIRE_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FIRE_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FIRE_Msg = 'امبروطور التفاعل' 
...
function Addjpg(msg,chat,ID_FIRELE,File_Name)
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FIRELE)) 
...
function AddFile_Bot(msg,chat,ID_FIRELE,File_Name)
...
--------------------------------------------------------------------------------------------------------------
function SourceFIRE(msg,data) -- بداية العمل
if msg then
...
if DevFIREW(msg) then
local bl = ' 💥 اهلا عزيزي آلمـطـور\n 💥 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 💥 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 💥 من خلاال الكيبورت خاص بك\n 💥 قناة سورس البوت [اضغط هنا](http://t.me/SOURCE1_FIRE)'
local keyboard = {
...
SourceFIREr = '💥 اهلا عزيزي\n 💥 انا بوت اسمي '..Namebot..'\n 💥 اختصاصي حمايه الجروبات\n 💥 من تكرار والسبام والتوجيه والخ…\n 💥 لتفعيلي اتبع الاخطوات…↓\n 💥 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ 💥 [قناة سورس البوت](http://http://t.me/SOURCE1_FIRE)'
end 
send(msg.chat_id_, msg.id_, SourceFIREr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevFIREW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevFIREW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,FIRE_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل 💥' and DevFIREW(msg) then  
...
if text == 'تعطيل التواصل 💥' and DevFIREW(msg) then  
...
if text == 'تفعيل البوت الخدمي 💥' and DevFIREW(msg) then  
...
if text == 'تعطيل البوت الخدمي 💥' and DevFIREW(msg) then  
...
if text == 'ضع كليشه ستارت 💥' and DevFIREW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 💥 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت 💥' and DevFIREW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 💥 تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر 💥' and DevFIREW(msg) then 
...
if text == 'تحديث السورس 💥' and DevFIREW(msg) then 
os.execute('rm -rf FIRE.lua')
os.execute('wget https://raw.githubusercontent.com/FIRETEAM/FIRE/master/FIRE.lua')
send(msg.chat_id_, msg.id_,' 💥 تم تحديث السورس \n 💥 لديك اخر اصدار لسورس فاير\n 💥 الاصدار » { 1.3v}')
dofile('FIRE.lua')  
end
if text == 'الاصدار 💥' and DevFIREW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 💥 اصدار سورس فاير \n 💥 الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت 💥' and DevFIREW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 💥 [تحديثات البوت](t.me/SOURCE1_FIRERE) \n 💥 [قناه السورس](http://t.me/SOURCE1_FIRE)')
end
if text == "ضع اسم للبوت 💥" and DevFIREW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 💥 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات 💥' and DevFIREW(msg) then 
...
if text == 'المشتركين 💥' and DevFIREW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 💥 المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات 💥' and DevFIREW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n 💥 الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين 💥") and DevFIREW(msg) then
...
if text == ("قائمه العام 💥") and DevFIREW(msg) then
...
if text == ("قائمه الكتم العام 💥") and DevFIREW(msg) then
...
if text=="اذاعه خاص 💥" and msg.reply_to_message_id_ == 0 and DevFIREW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 💥 ارسل الان اذاعتك؟ \n 💥 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه 💥" and msg.reply_to_message_id_ == 0 and DevFIREW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 💥 ارسل الان اذاعتك؟ \n 💥 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت 💥" and msg.reply_to_message_id_ == 0 and DevFIREW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 💥 ارسل الان اذاعتك؟ \n 💥 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه 💥" and msg.reply_to_message_id_ == 0  and DevFIREW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 💥 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص 💥" and msg.reply_to_message_id_ == 0  and DevFIREW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 💥 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه 💥' and DevFIREW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين 💥" and DevFIREW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات 💥" and DevFIREW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'💥  عدد الجروبات الان » { '..#group..' }'..FIREk..''..FIRE..'\n💥  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevFIREW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevFIREW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevFIREW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevFIREW(msg) then
...
local FIRE1_Msg = database:get(bot_id.."FIRE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FIRE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if FIRE_Msg and not Special(msg) then  
local FIRE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FIRE_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 💥 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 💥 ["..FIRE_Msg.."] \n")
else
send(msg.chat_id_,0," 💥 العضو : {["..data.first_name_.."](http://t.me/SOURCE1_FIRERE)}\n 💥 ["..FIRE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 💥 عذرا » {["..data.first_name_.."](http://t.me/SOURCE1_FIRERE)}\n 💥 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevFIREW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevFIREW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevFIREW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 💥 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevFIREW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 💥 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك 💥" and DevFIREW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 💥 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 💥$") and DevFIREW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 💥 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 💥" and DevFIREW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 💥" and DevFIREW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 💥 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 💥" and DevFIREW(msg) then  
...
database:sadd(bot_id.."FIRE:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."FIRE:blocname"..msg.chat_id_)
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."FIRE:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."FIRE:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."FIRE:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."FIRE:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."FIRE:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."FIRE:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Boykae_new(Boyka1,Boyka2)
if Boyka2 and Boyka2.first_name_ then 
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."FIRE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."FIRE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."FIRE:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."FIRE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Boyka_nnn2) == tonumber(Boyka_nnn) or tonumber(Boyka_nnn2) > tonumber(Boyka_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."FIRE:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "💥 عزيزي >>["..Boyka2.username_.."](https://t.me/"..(Boyka2.username_ or "pvv_v")..")\n💥 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."FIRE:teh"..msg.chat_id_).."} بجانب اسمك\n💥 عدد المحاولات المتبقيه {"..(tonumber(Boyka_nnn) - tonumber(Boyka_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Boykae_new)
end
end
...
local FIREChengName = database:get(bot_id.."FIRE:Cheng:Name"..data.id_)
if not data.first_name_ then 
if FIREChengName then 
send(msg.chat_id_, msg.id_, " كان معرف حلو ["..FIREChengName..']')
database:del(bot_id.."FIRE:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if FIREChengName ~= data.first_name_ then 
local Text = {
  "الواد ده غير اسمو",
"غيرت اسمك لي",
"اسمك القديم خرا😉",
...
database:set(bot_id.."FIRE:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local FIREChengUserName = database:get(bot_id.."FIRE:Cheng:UserName"..data.id_)
if not data.username_ then 
if FIREChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بسرعه بسرعه  \n هاذه معرفه  : [@"..FIREChengUserName..']')
database:del(bot_id.."FIRE:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if FIREChengUserName ~= data.username_ then 
local Text = {
'فضايح🥺',
"فضحوك ف قنواتهم",
"غيرت معرفك لي😐🌝",
"غير معرفه خمطو بسرعه بسرعه \n هاذه معرفه : @"..data.username_.."",
'معرفك حلو \n غيرتو لي @'..data.username_..' ',
'اشتريت معرفك بكام', 
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."FIRE:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local FIREChengPhoto = database:get(bot_id.."FIRE:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if FIREChengPhoto then 
send(msg.chat_id_, msg.id_, "اي الصوره دي?")
database:del(bot_id.."FIRE:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if FIREChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "صورتك خرااااا",
  "حلوه الصوره الجديده",
  "مش حلوه الصوره دي",
  "قامده الصوره دي 😹😹🌚",
  "غيرت صورتك لي؟😹🌞",
  "كل شويه بتغير الصوره🤔🌞",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."FIRE:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
DEV¹ : [DARK ](http://t.me/DA_RKK
DEV² : [TURKEYY](http://t.me/HH22H)
DEV³ : [PICASO](http://t.me/PI_C_ASO)

❥---------------------------------------------------❥
[💥SOURCE FIRE💥](http://t.me/SOURCE1_FIRE)

[💥TO TALK TO US💥](http://t.me/http://t.me/SOURCE_FIRE_BOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevFIREW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local ID_FIRELE = result.content_.document_.document_.persistent_id_ 
local File_Name = result.content_.document_.file_name_
AddFile_Bot(msg,msg.chat_id_,ID_FIRELE,File_Name)
end   
end
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevFIREW(msg) then    
dofile('FIRE.lua')  
send(msg.chat_id_, msg.id_, ' 💥 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevFIREW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevFIREW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevFIREW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevFIREW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevFIREW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevFIREW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevFIREW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevFIREW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevFIREW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevFIREW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevFIREW(msg) then
...
if text == 'الملفات' and DevFIREW(msg) then
t = ' 💥 ملفات السورس فاير ↓\n≪━━━━━━Fi━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevFIREW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FIRETEAM/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 💥 اهلا بك في متجر ملفات فاير\n 💥 ملفات السورس ↓\n≪━━━━━━Fi━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━Fi━━━━━━≫\n 💥 علامة تعني { ✓ } ملف مفعل\n 💥 علامة تعني { ✘ } ملف معطل\n 💥 قناة سورس فاير ↓\n".." 💥 [اضغط هنا لدخول](http://t.me/SOURCE1_FIRE) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevFIREW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FIRETEAM/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevFIREW(msg) then
...
if text == "مسح الملفات" and DevFIREW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," 💥 تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevFIREW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevFIREW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_FIRE(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_FIRE, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_FIRE, nil)
return false 
end
...
elseif data.message_ == "CHAT_NOT_MODIFIREED" then
...
database:set(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 💥 ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FIRE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FIRE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 💥 تم منع الكلمه مع التحذير")  
database:del(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FIRE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FIRE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FIRE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 💥 ارسل الكلمه الان")  
database:set(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FIRE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FIRE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FIRE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FIRE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FIRE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FIRE1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 💥 قائمة المنع \n≪━━━━━━Fi━━━━━━≫\n"
for k,v in pairs(list) do  
local FIRE_Msg = database:get(bot_id.."FIRE1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FIRE_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevFIREW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 💥 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevFIREW(msg) then
...
if text == 'تفعيل الاذاعه' and DevFIREW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevFIREW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..FIRE_Msg[math.random(#FIRE_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevFIREW(msg) then 
...
if text == ("مسح ردود المطور") and DevFIREW(msg) then 
...
if text == ("ردود المطور") and DevFIREW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 💥 قائمة ردود المطور \n≪━━━━━━Fi━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevFIREW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevFIREW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevFIREW(msg) then   
...
if text == 'تعطيل المغادره' and DevFIREW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n💥 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'FIRE')..') '
...
-- vardump(data) 
FIREdx(msg.chat_id_, msg.id_, ' 💥 ايدي المجموعة » ( '..msg.chat_id_..' )\n 💥 عدد الادمنيه » ( *'..data.administrator_count_..' )*\n 💥 عدد المحظورين » ( *'..data.kicked_count_..' )*\n 💥 عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevFIREW(msg) then
...
*💥م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━Fi━━━━━━≫ٴ
彡 .[SOURCE FIRE](http://t.me/SOURCE1_FIRE)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ💥ٴ≪━━━━━━Fi━━━━━━≫ٴ💥○ٴ\n💥 彡 .[SOURCE FIRE](http://t.me/SOURCE1_FIRE)➢ ')
end
...
local texting = {"بتاع بنات وهفضحك🥺"," عيل خول  😶","ده شاذ 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك بهاي" or text == "شنو رئيك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"حلوه😹","خرا ☹️😾","فاجره♥ 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "نيكو" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"تعال مص فزبي","فكك منو ده معرص","زبي منجا"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مصه" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"في الخاص مش هنا ♥","مووووووه","لا عيب"," لا كفايه😏","لا ده معفن","لي??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
function FunBot(extra, result, success) 
local Fun = {'مش بحب اكدب ','مش بحبو ',' لا بكرهو ','اه بحبو'}
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
FIRE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FIRE)
...
------------------------------------------------------------------------
local FIREAbot = database:get(bot_id.."FIRE1:Add:Filter:Rp2"..text..result.chat_id_)   
if FIREAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 💥 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 💥 ["..FIREAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FIRE1_Msg = database:get(bot_id.."FIRE1:Add:Filter:Rp2"..text..result.chat_id_)   
if FIRE1_Msg then    
send(msg.chat_id_, msg.id_," 💥 "..FIRE1_Msg)
