...
if redis:get(FLASH..'group:add'..msg.chat_id_) then  return '⋆**المجموعه بالتأكيد تم تفعيلها' end
...
if not redis:get(FLASH..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
.."\n1-╿التعديل ⇽ "..(redis:get(FLASH..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط ⇽ "..(redis:get(FLASH..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك ⇽ "..(redis:get(FLASH..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات ⇽ "..(redis:get(FLASH..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار ⇽ "..(redis:get(FLASH..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش ⇽ "..(redis:get(FLASH..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب ⇽ "..(redis:get(FLASH..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان ⇽ "..(redis:get(FLASH..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات ⇽ "..(redis:get(FLASH..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات ⇽ "..(redis:get(FLASH..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار ⇽ "..(redis:get(FLASH..'num_msg_FLASH'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه ⇽ "..(redis:get(FLASH..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه ⇽ "..(redis:get(FLASH..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين ⇽ "..(redis:get(FLASH..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب ⇽"..(redis:get(FLASH..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور ⇽ "..(redis:get(FLASH..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو ⇽ "..(redis:get(FLASH..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات ⇽ "..(redis:get(FLASH..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت ⇽ "..(redis:get(FLASH..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات ⇽ "..(redis:get(FLASH..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات ⇽ "..(redis:get(FLASH..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه ⇽ "..(redis:get(FLASH..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع ⇽ "..(redis:get(FLASH..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات ⇽ "..(redis:get(FLASH..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات ⇽ "..(redis:get(FLASH..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد ⇽ "..(redis:get(FLASH..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب ⇽ "..welcomex
.."\n*2-│*الردود ⇽ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك ⇽ "..(redis:get(FLASH..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات ⇽ "..(redis:get(FLASH..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل ⇽ "..(redis:get(FLASH..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط ⇽ "..(redis:get(FLASH..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار ⇽ "..(redis:get(FLASH..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش ⇽ "..(redis:get(FLASH..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب ⇽ "..(redis:get(FLASH..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان ⇽ "..(redis:get(FLASH..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد ⇽ "..(redis:get(FLASH..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات ⇽ "..(redis:get(FLASH..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار ⇽ "..(redis:get(FLASH..'num_msg_FLASH'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه ⇽ "..(redis:get(FLASH..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور ⇽ "..(redis:get(FLASH..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط ⇽ "..(redis:get(FLASH..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه ⇽ "..(redis:get(FLASH..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو ⇽ "..(redis:get(FLASH..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
