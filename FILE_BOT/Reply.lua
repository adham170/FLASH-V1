...
if text == 'باندا' then 
send(msg.chat_id_,msg.id_, ' [مبرمج السورس ](t.me/uu_ban) ') 
return false
end

if text == 'بويكا' then 
send(msg.chat_id_,msg.id_,  '[بويكا الهكر.](t.me/b_o_y_k_a_a)')
return false
end

if text == 'سالي' then 
send(msg.chat_id_,msg.id_,  '[مطوره السورس.](t.me/M_X_3)')
return false
end
